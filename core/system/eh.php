...
class eh
{
  ...
  public static function exception($e)
  {
    ...
    die('<pre>'.(self::$debug === true ? $error . "\n<strong>Remember to disable error output in config.php!</strong>" : 'Exception error! Look in log file for more information.').'</pre>');
  }
  ...
  public static function error($errno, $errmsg, $filename, $linenum, $vars)
  {
    ...
    die('<pre>'.(self::$debug === true ? $error . "\n<strong>Remember to disable error output in config.php!</strong>" : 'Error! Look in log file for more information.').'</pre>');
  }
}
