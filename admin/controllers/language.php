...
class language
{
    ...
    public static function index()
    {
        ...
        {
            self::$vars['error'] = 'There is difference between table columns and configuration file language array <a href="'.site_url('language/setup').'">Change language database!</a>';
        }
